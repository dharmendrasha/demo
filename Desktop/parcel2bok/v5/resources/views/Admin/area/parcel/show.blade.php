            ...
            <tbody>
                @foreach ($carrierList as $l)
                    ...
                    {{-- <td><span class="badge badge-pill badge-danger">{{$l->startingRange}}</span>&nbsp;&nbsp;To&nbsp;&nbsp;<span class="badge badge-pill badge-success">{{$l->EndingRange}}</span></td> --}}
                        <td>
                        <button type="button" name="" id="" class="btn btn-primary" onclick="window.location.href='{{route('admin.parcel.update',['id' => $l->id])}}'" btn-lg btn-block">Update</button>
                        <button type="button" name="" id="" class="btn btn-danger" onclick="window.location.href = '{{route('admin.parcel.delete',['id' => $l->id])}}'" btn-lg btn-block">Delete</button>
                        </td>
                </tr>
                @endforeach
            </tbody>
