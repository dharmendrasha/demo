{{--start--}}
<div class="container">
<form action="{{route('admin.listAllUser.deliverPost',['awb'=>$awb])}}" method="POST" enctype="multipart/form-data">
    @csrf
        <div class="row">
            ...
            <div class="col">
                <div class="form-group">
                  ...
                  <input type="text"
                class="form-control @error('awb') is-invalid @enderror" name="awb" value="{{$awb}}" id="awb" aria-describedby="theAwb" placeholder="The awb">
            ...
            <div class="col">
                <div class="form-group">
                  ...
                  <select class="form-control @error('parcelStatus') is-invalid @enderror" name="parcelStatus" id="parcelStatus">
                    <option selected disabled>Select the user status with quck action</option>
            ...
            <div class="col">
                <div class="form-group">
                  ...
                  <textarea class="form-control @error('customNotice') is-invalid @enderror" placeholder="Write custom notice to the customer" name="customNotice" id="customNotice" rows="5"></textarea>
                  @error('customNotice')
                  <span class="invalid-feedback text-danger" role="alert">
                      <strong>{{ $message }}</strong>
                  </span>
